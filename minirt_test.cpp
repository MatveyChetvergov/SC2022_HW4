...
public:
    ...
    ThreadPool(int ThreadsNumber, const Scene &scene, const Image &image, ViewPlane &viewPlane) : viewPlane(viewPlane) 
    {
        this->scene = scene;
        this->image = image;
        this->ThreadsNumber = ThreadsNumber;
        InitializeWorkers(ThreadsNumber);
    };

    void InitializeWorkers(int ThreadsNumber) 
    {
...
int main(int argc, char **argv) 
{
    ...
    auto threadPool = new ThreadPool(32, scene, image, viewPlane);
